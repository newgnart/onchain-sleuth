...
class EtherscanClient(BaseAPIClient):
    ...
    def __init__(self, chainid: int, api_key: Optional[str] = None, calls_per_second: float = 5.0):
    ...
    def get_latest_block(self, timestamp: Optional[int] = None, closest: str = "before") -> int:
    ...
    def get_contract_abi(self, address: str, save: bool = True, save_dir: str = "data/abi") -> Dict[str, Any]:
    ...
    def get_contract_metadata(self, address: str) -> Dict[str, Any]:
        ...
        self.logger.info(f"Fetching metadata for contract {address} on chain {self.chainid}")
    ...
    def get_transaction_receipt(
        ...
        self.logger.info(f"Getting transaction receipt for {txhash} on chain {self.chainid}")
    ...
    def get_contract_creation_info(self, contract_addresses: List[str]) -> Dict[str, Any]:

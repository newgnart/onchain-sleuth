...
class DataTransformer:
    ...
    @staticmethod
    def safe_convert_large_integers(
        item: Dict[str, Any], fields: List[str] = None
    ) -> None:
    ...
    def process_timestamps(
        item: Dict[str, Any], timestamp_fields: List[str] = None
    ) -> None:
    ...
    def standardize_item(
        self, item: Dict[str, Any], transformations: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        ...
        if "large_integer_fields" in transformations:
            self.safe_convert_large_integers(
                item, transformations["large_integer_fields"]
            )
        else:
